...
`coarse_terms` 是摘要标签，但 hidden 使用前还要按 feature category 过滤证据词。relation 的稳定身份词/称呼（如“老公”）不能作为普通事实或副核心是否仍活跃的证据，否则高频称呼会让“老公叫她点糖醋排骨”永久无法 hidden；此类摘要只用“糖醋排骨”等事件独有词。relation 自身是否保护摘要仍完全由 takeover 判断，不靠这一过滤。若过滤后没有事实核心词，保守 keep，不猜测。
